...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Sản phẩm sau khi tạo mới").child(key);
...
updateButton.setOnClickListener(new View.OnClickListener() {
    ...
    public void saveData(){
        storageReference = FirebaseStorage.getInstance().getReference().child("Hình ảnh của sản phẩm").child(uri.getLastPathSegment());
